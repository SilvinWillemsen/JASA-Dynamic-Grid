...
\begin{subequations}\label{eq:interpolationGeneral}
    \begin{align}
        u_{M+1}^n &= I^*(x^n_{u_{M+1}})w_l^n% = (1-\alpha)w_1^n + \alpha w_0^n
        \\
        w_{-1}^n &= I(x^n_{w_{-1}})u_l^n,% = (1-\alpha)u_{M-1}^n + \alpha u_M^n
    \end{align}
\end{subequations}
...
\begin{subequations}
    \begin{align}
        u_{M+1}^n &= I_1^*(x^n_{u_{M+1}})w_l^n = (1-\alpha)w_1^n + \alpha w_0^n
        \\
        w_{-1}^n &= I_1(x^n_{w_{-1}})u_l^n = (1-\alpha)u_{M-1}^n + \alpha u_M^n
    \end{align}
\end{subequations}
where
\begin{equation}
